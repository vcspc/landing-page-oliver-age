  ...
  return (
    <div className={style.fundo}>
      ...
      <div className={style.container}>
        ...
        <video className={style.video} src="/depoimento4.mp4" controls />
        <video className={style.video} src="/depoimento5.mp4" controls />
        <video className={style.video} src="/depoimento6.mp4" controls />
      </div>
